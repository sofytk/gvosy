...
fun LogInScreen(navController: NavController, viewModel: UserViewModel) {
    AppTheme {
        ...
        Column(
            ...
            Text(text = "Log in", fontSize = subTitleTextSize, color = MaterialTheme.colorScheme.onBackground)
            ...
            Button(
                ...
                onClick = {
                    viewModel.loginUser(userEmail, password)
                }
            ) {
                Text(
                    modifier = Modifier.padding(end = 1.dp), text = "Continue",
